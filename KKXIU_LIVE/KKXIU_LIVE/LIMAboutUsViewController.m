...
@interface LIMAboutUsViewController ()

@end

@implementation LIMAboutUsViewController
...
- (void)viewDidLoad {
    ...
    [gameWeb loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:self.aboutusurl]]];
