...
#define lFont [UIFont boldSystemFontOfSize:17.5]
#define lFontSize 17.5
#define lTextColor_N [UIColor colorWithHexString:@"838383"]
...
@implementation LIMCharmSegment
