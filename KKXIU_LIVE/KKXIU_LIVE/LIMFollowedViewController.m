...
@interface LIMFollowedViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LIMFollowedViewController
...
- (void)creteTableView{
    ...
    [tableView registerClass:[LIMFansTableViewCell class] forCellReuseIdentifier:@"LIMFansTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LIMFollowModel *followModel = self.dataSource[indexPath.row];
    LIMFansTableViewCell *hotLiveCell = [tableView dequeueReusableCellWithIdentifier:@"LIMFansTableViewCell" forIndexPath:indexPath];
...
- (void)httpLiveFollowList{
    ...
    [[HttpClient defaultClient] requestWithPath:mFans_List method:1 parameters:paraDict prepareExecute:^{
...
- (void)followOther:(NSInteger)indexPath{
    ...
    [paraDict addEntriesFromDictionary:[userModel httpParaDictUnSecret]];
    [[HttpClient defaultClient] requestWithPath:mFans_delete method:1 parameters:paraDict prepareExecute:^{
