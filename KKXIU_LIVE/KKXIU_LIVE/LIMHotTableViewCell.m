...
@implementation LIMHotTableViewCell
...
- (void)createDetailView{
    ...
    cityLabel.layer.backgroundColor = [UIColor colorWithHexString:@"ffffff" alpha:0.8].CGColor;
...
//    }];
    ...
    [_gameIcon sd_setImageWithURL:[NSURL URLWithString:liveModel.gameimg]];
//    _peopleIcon;
//    _gameIcon;
}
