...
@interface LIMLastLiveViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) NSMutableArray *dataSource;

@end

@implementation LIMLastLiveViewController
...
{
    LIMLiveListModel *model = self.dataSource[indexPath.row];
...
//    @property (weak, nonatomic) IBOutlet UILabel *minuteLabel;
    [cell.backImage sd_setImageWithURL:[NSURL URLWithString:model.cover]];
    cell.nameLabel.text = model.nickname;
    cell.minuteLabel.text = model.distince;
...
//                               };
    ...
    [[HttpClient defaultClient] requestWithPath:mNear_Home method:1 parameters:paraDict prepareExecute:^{
