...
@interface LIMPageView()<UIScrollViewDelegate>{
...
- (void)reloadData{
    ...
    if (nil != _datasource) {
        _numberOfItems = [_datasource numberOfItemInLIMPageView:self];
...
- (NSMutableArray*)itemsArray{
    ...
    if (_itemsArray == nil) {
        NSInteger total = [_datasource numberOfItemInLIMPageView:self];
