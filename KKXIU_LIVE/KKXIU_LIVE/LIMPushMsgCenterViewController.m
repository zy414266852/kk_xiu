//
//  LIMPushMsgCenterViewController.m
//  KKXIU_LIVE
//
...
#import "LIMPushAdminViewController.h"
#import "LIMPushNoticeViewController.h"
...
@interface LIMPushMsgCenterViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LIMPushMsgCenterViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    UITapGestureRecognizer *tapGest = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(dismissThisView)];
...
//    self.view.backgroundColor = [UIColor colorWithHexString:@"ffffff"];
    ...
    // 拟导航条
    UIView *titleView = [[UIView alloc]initWithFrame:CGRectMake(0, kScreenH -kPushMsgH, kScreenW, 44)];
    ...
    [nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.center.equalTo(titleView).offset(0);
    ...
    [line mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(titleView).offset(14);
...
- (void)creteTableView{
    ...
    UITableView* tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, kScreenH -300, kScreenW,300) style:UITableViewStylePlain];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([chatListModel.kkID isEqualToString:strangerKKID]) {     // 陌生人消息
        LIMPushStrangerViewController *stranger  = [[LIMPushStrangerViewController alloc]init];
//        [self.navigationController pushViewController:stranger animated:YES];
        stranger.view.backgroundColor = [UIColor colorWithWhite:1 alpha:0];
        stranger.modalPresentationStyle = UIModalPresentationOverFullScreen;
        //        [self.navigationController pushViewController:v animated:YES];
        [self presentViewController:stranger animated:YES completion:^{
            
        }];

    }else if ([chatListModel.kkID isEqualToString:noticeKKID]) { // 系统公告
        LIMPushNoticeViewController *stranger  = [[LIMPushNoticeViewController alloc]init];
...
//        [self.navigationController pushViewController:stranger animated:YES];
        ...
        LIMPushAdminViewController *v =[[LIMPushAdminViewController alloc]init];
...
- (void)refreshMsg{
    ...
    [[TIMFriendshipManager sharedInstance] getUsersProfile:type_1List succ:^(NSArray * arr) {
        [arr enumerateObjectsUsingBlock:^(TIMUserProfile * profile, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            if ([text_elem isKindOfClass:[TIMTextElem class]]) {
