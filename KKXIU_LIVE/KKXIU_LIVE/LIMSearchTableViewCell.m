...
@interface LIMSearchTableViewCell()

@end

@implementation LIMSearchTableViewCell
...
- (void)createDetailView{
    ...
    followedLabel.text = @"已关注";
    followedLabel.textColor = [UIColor colorWithWhite:0.7 alpha:1];
    followedLabel.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1];
    followedLabel.font = [UIFont systemFontOfSize:14];
    followedLabel.hidden = YES;
    followedLabel.textAlignment = NSTextAlignmentCenter;
    followedLabel.layer.cornerRadius = 10.5;
