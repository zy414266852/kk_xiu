...
#define lPadding (kScreenW - 62)/2.0
#define lFont [UIFont boldSystemFontOfSize:15]
#define lFontSize 15
#define lTextColor_N [UIColor colorWithHexString:@"9eb1b3"]
#define lTextColor_S [UIColor colorWithHexString:@"ffffff"]
//#define lDivideColor_N [UIColor colorWithHexString:@"ffffff"]
#define lDivideColor_S [UIColor colorWithHexString:@"ffffff"]

#define lScrollContentSize CGSizeMake(256*kiphone6,0)

@interface LIMSegment(){
    NSArray *widthArray;
