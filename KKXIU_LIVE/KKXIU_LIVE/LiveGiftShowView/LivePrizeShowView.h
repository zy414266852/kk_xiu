...
#import "LivePrizeShowNumberView.h"
#import "LivePrizeShowCustom.h"

static CGFloat const kViewWidth = 230.0;//背景宽
static CGFloat const kViewHeight = 41.0;//背景高

@interface LivePrizeShowView : UIView
...
@property (nonatomic ,strong) LivePrizeShowModel * model;/**< 数据源*/

@property (nonatomic, assign) LiveGiftHiddenMode hiddenModel;/**< 消失模式*/

@property (nonatomic ,weak) LivePrizeShowNumberView * numberView;
...
@property (nonatomic ,copy) void(^liveGiftShowViewTimeOut)(LivePrizeShowView *);
