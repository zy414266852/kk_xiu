...
//            make.centerY.equalTo(_keyBoardContainer).offset(0);
//            make.right.equalTo(_keyBoardContainer).offset(-10);
...
//        /
        ...
        sendMessage.frame = CGRectMake(SDDeviceWidth-30-10 -30,(inputViewDefaultHeight-30)/2,60, 30);
        ...
        [_inputViewContainer addSubview:sendMessage];
        _sendMessageBtn = sendMessage;
        //添加图片
...
//        self.failBtn.frame = CGRectMake(SDDeviceWidth-30-10,(inputH-30-10),30, 30);
        _sendMessageBtn.frame = CGRectMake(SDDeviceWidth-30-10 -30,(inputH-30-10),60, 30);
