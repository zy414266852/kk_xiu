...
// 音频采样率 , 取值设置为 枚举值 TX_Enum_Type_AudioSampleRate，也可直接设置为对应的采样率 ，比如 audioSampleRate = AUDIO_SAMPLE_RATE_48000 或  audioSampleRate = 48000
...
/**
 *  RTMP传输通道的类型，取值为枚举值：TX_Enum_Type_RTMPChannel
