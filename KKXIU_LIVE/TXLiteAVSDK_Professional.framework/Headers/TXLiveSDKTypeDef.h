...
typedef NS_ENUM(NSInteger, TX_Enum_Type_AutoAdjustStrategy) {
    AUTO_ADJUST_NONE                        = 0,      //无流控
    AUTO_ADJUST_BITRATE_STRATEGY            = 1,      //只调码率
    AUTO_ADJUST_BITRATE_RESOLUTION_STRATEGY = 2,      //同时调码率和分辨率
    AUTO_ADJUST_BITRATE_STRATEGY2           = 3,      // 已经废弃不用
    AUTO_ADJUST_BITRATE_RESOLUTION_STRATEGY2= 4,      // 已经废弃不用
    AUTO_ADJUST_REALTIME_VIDEOCHAT_STRATEGY = 5,      //实时
};
